...
import type { DeliveryInfo } from "../backend";
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-start gap-3 p-4 bg-destructive/10 border border-destructive/40 rounded-lg">
          ...
          <div>
            ...
            <p className="text-destructive/90 text-sm mt-0.5">
              Orders <strong>cannot be cancelled</strong> once placed. Please
              review your order details carefully before closing this window.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="font-bold text-primary text-xl">
            {formatINR(orderData.totalAmountINR)}
          </span>
        </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="text-foreground font-medium">
                  {orderData.deliveryInfo.companyName}
                </span>
              </div>
            </div>
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="text-foreground font-medium">
                  {orderData.deliveryInfo.companyAddress}
                </span>
              </div>
            </div>
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="text-foreground font-medium">
                  {orderData.deliveryInfo.contactNumber}
                </span>
              </div>
            </div>
            <div className="flex items-start gap-2">
