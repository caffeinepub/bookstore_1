...
import { Minus, Plus, Trash2, ShoppingCart, ArrowRight, BookOpen } from 'lucide-react';
  ...
  if (items.length === 0) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-muted-foreground mb-6">Browse our catalog and add some books!</p>
        <Button asChild>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="font-serif text-3xl font-bold text-foreground mb-8">
        Shopping Cart
        <span className="text-muted-foreground text-lg font-normal ml-3">({totalItems} items)</span>
      </h1>
