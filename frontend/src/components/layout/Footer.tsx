        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link to="/" className="hover:text-foreground transition-colors">Book Catalog</Link></li>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Browse our curated collection of books with exclusive community discounts. 
              Secure ordering powered by the Internet Computer.
            </p>
          </div>
        </div>
